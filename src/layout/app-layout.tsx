...
import { FiMail, FiUsers, FiMenu, FiUser, FiMessageCircle, FiFile, FiBox, FiHeart, FiBriefcase } from 'react-icons/fi';
...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Follow', path: '/follows', entity: 'follow', service: AccessServiceEnum.PROJECT, icon: FiHeart },
    { name: 'Stock Idea', path: '/stock-ideas', entity: 'stock_idea', service: AccessServiceEnum.PROJECT, icon: FiBox },
